...
if __name__ == '__main__':
    ...
    mail_title = 'tracking项目线上监控'
    receive_mail_list = [
        'keke.jiao@marcpoint.com',
        # 'evonne.liu@marcpoint.com'
    ]
    username = 'marc'
    password = 'Aa1234'
    # 正式监控
    main(username, password, mail_title, receiver=receive_mail_list)
    # 数据调试
    # json_ = open(r'F:\宏原测试\测试项目\mock\tracking\report-details', 'r', encoding='utf-8')
    # SD = ReportDataCheck(json.loads(json_.read()))
    # SD.spread_efficiency_check()
    # dataCheck(json.loads(json_.read()))
    # date_diff('2019-09-08', '2019-09-18')
    # json_.close()
